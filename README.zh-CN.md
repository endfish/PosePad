...
PosePad 是一个适用于最终幻想 XIV 的 Dalamud 插件，用来把常用姿势，例如站姿 1、2、3，坐姿 1、2、3，以及情感动作、表情动作整理成一个直观的按钮面板，方便在 GPose、截图、演出和角色扮演场景中配合 Mod 快速使用。很多动作 Mod 都依赖这些姿势，而每次手动输入编号会非常麻烦，PosePad 的目标就是把这件事变得更直接。
